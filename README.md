...
- Modify the contents of `.env` by either opening `J1T_GUI` or editing the file directly ([generate ouath token here](https://twitchtokengenerator.com/)) and save. **YOU MAY HAVE TO ADD `oauth:` TO THE START OF THE TOKEN IF IT ISN'T THERE!** This new generator doesn't add it.
